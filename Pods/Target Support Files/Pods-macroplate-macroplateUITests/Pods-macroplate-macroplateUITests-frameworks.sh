...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Flurry-iOS-SDK-framework/Flurry_iOS_SDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKRingProgressView-framework/MKRingProgressView.framework"
